  ...
  return (
    <div className="overflow-x-auto p-0 rounded-lg mt-3">
        <table className="min-w-full border-collapse border border-gray-200">
            ...
            <tbody>
                {tableData.map((task)=>(
                    <tr key={task._id} className="border-t border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <td className="py-4 px-4 text-gray-700-[13px] text-nowrap hidden md:table-cell ">{task.createdAt ? moment(task.createdAt).format('Do MMM YYYY'):'N/A'}</td>
                    </tr>
                ))}                
            </tbody>
        </table>
